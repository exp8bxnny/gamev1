...
else if (battle_state == "enemy_attack")
{
    ...
    {
        array_push(enemy_attack_x, random(1));
        array_push(enemy_attack_y, 0);
    ...
    for (var i = array_length(enemy_attack_y) - 1; i >= 0; i--)
    {
        enemy_attack_y[i] += attack_fall_speed * seconds;
        ...
        )
        {
            ...
            array_delete(enemy_attack_x, i, 1);
            array_delete(enemy_attack_y, i, 1);
    ...
    if (enemy_turn_timer <= 0 && battle_state == "enemy_attack")
    {
...
else if (battle_state == "victory")
{
    ...
    if (keyboard_check_pressed(ord("Z")) && input_delay <= 0)
    {
        ...
        {
            // Remember that the enemy was defeated
